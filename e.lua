...
welcomemessage.Text = "WELCOME TO TYPICAL HUB"
...
TextLabel.Text = "Credits to Mizt, mixuuh, SyndiCat and the owners of the scripts."
...
TextLabel_3.Text = "New crappy UI"
...
TextLabel_4.Text = "Fixes within merges (hopefully)"
...
TextLabel_5.Text = "and we added support to void."
...
memes.Text = "shiba hub users : it works tho!"
...
local function EGTRRF_fake_script() -- memes.LocalScript 
	...
	while true do
		...
		script.Parent.Text = "typicalhub is good ig"
		wait(5)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
		script.Parent.Text = "im trying to fix the merging k?"
		wait(5)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
		script.Parent.Text = "mixuuh thinks im jesus"
		wait(5)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
		script.Parent.Text = "chaos, the chaos"
		wait(5)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
		script.Parent.Text = "why does the merging happen!?!"
		wait(5)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
		...
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
		script.Parent.Text = "void is legit oxygen u but better"
		wait(5)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
		script.Parent.Text = "hi syndicat"
		wait(5)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
		script.Parent.Text = "pog champ"
		wait(5)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
		script.Parent.Text = "shiba reanim is so fast but so bad"
		wait(5)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
		wait(1)
		local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
...
Swat.Name = "Swat"
Swat.Parent = HatScripts
Swat.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
Swat.BorderSizePixel = 0
Swat.Position = UDim2.new(0, 0, 0, 0)
Swat.Size = UDim2.new(0, 451, 0, 34)
Swat.AutoButtonColor = false
...
railgunner.Parent = HatScripts
railgunner.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
railgunner.BorderSizePixel = 0
railgunner.Position = UDim2.new(0, 0, 0, 0)
railgunner.Size = UDim2.new(0, 451, 0, 34)
railgunner.AutoButtonColor = false
railgunner.Font = Enum.Font.Gotham
